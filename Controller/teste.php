...
require 'vendor/autoload.php'; // Esta linha carrega automaticamente todas as classes do Composer, incluindo o PHPMailer
...
$mail->addAddress('lucascaina.bsb.ferreira@gmail.com'); // Insira o endereço de e-mail do destinatário
